...
try {
    ...
    $stmt = $conn->prepare("UPDATE reviews SET rating = :rating, comment = :comment, created_at = NOW() WHERE id = :review_id AND user_id = :user_id");
    ...
    error_log("Database error in edit_review: " . $e->getMessage());
    http_response_code(500);
    echo json_encode([
        "success" => false, 
